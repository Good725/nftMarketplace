...
function MarketCardOpulent(props) {
  const reDirectToBuy = () => {
  ...
  return (
    <>
      <div className='card__item hello' onClick={reDirectToBuy}>
        <Card
          hoverable={true}
          style={{
            width: '100%',
          ...
          >
            ...
            >
              <img
                ...
                alt='image1'
                src={
                  // IF CARD IS AN IMAGE, videoPreview is set to false
...
export default MarketCardOpulent;
